  ...
  const finalContributions = (sortedContribution) => {
    ...
    students.forEach((student) => {
      ...
      if (sortedContribution[count] == undefined) {
        ...
        const tempContB = completeContribution.concat(
          sortedContribution[count]
        );
        setCompleteContribution(tempContB);
        setCount(count + 1);
        console.log("b");
      } else {
        const tempContC = completeContribution.concat(EmptyContribution[0]);
        setCompleteContribution(tempContC);
        console.log("c");
      }
